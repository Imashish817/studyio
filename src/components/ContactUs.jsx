    ...
    const handleForm = async () => {
        ...
        else if(Phone.length!=10)
        {
            ...
            try {
                ...
                const response = await api("https://script.google.com/macros/s/AKfycbxC5rXrhiU9I8afRKpjy08KwqAJ0KrXgthIFEZoyqa6A76iEBctpDKASMkucgh7wWzgNg/exec", {
                  method: 'POST',
        ...
        <section class="py-24">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 grid-cols-1">
                    ...
                    <form ref={formRef} class="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                        ...
                        <div className='flex justify-center'>
                            <button onClick ={handleForm}className="relative inline-flex h-12 overflow-hidden rounded-full p-[4px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
