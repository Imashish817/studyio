  ...
  return (
    (<motion.div
      ...
      <motion.div
        ...
        <img
          src="https://i.ibb.co/8K4wPyP/pp.png"
          alt="avatar"
          height="200"
          width="200"
        ...
        <p
          className="border border-orange-500  text-orange-500  rounded-full px-2 py-0.5 mt-4">
         International Collaboration
        </p>
        <p
          className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
          Partnered with top universities across the globe
        </p>
      </motion.div>
      <motion.div
        className="h-full relative z-20 w-1/3 rounded-2xl bg-white p-4 border border-neutral-200 flex flex-col items-center justify-center">
        <img
          src="https://i.ibb.co/2csP0jv/8992931.png"
          alt="avatar"
          height="200"
          width="200"
          className="rounded-full h-24 w-24" />
      ...
      <motion.div
        ...
        className="h-full w-1/3 rounded-2xl bg-white p-4 border border-neutral-200 flex flex-col items-center justify-center">
        <img
          src="https://i.ibb.co/Ks6c8Qq/aim-3.png"
          alt="avatar"
          height="200"
          width="200"
          className="rounded-full h-24 w-24" />
