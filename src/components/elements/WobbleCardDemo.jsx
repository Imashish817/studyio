  ...
  return (
    (<>
      <div
        ...
        <div className="max-w-2xl mx-auto  px-4 md:px-8 lg:px-10 ">
          ...
          <p className="text-lg text-purple-900 md:text-4xl mb-4  max-w-4xl font-semibold">
            Our Mission  <span className="text-orange-500 drop-shadow-xl">in Motion</span>
          </p>
      ...
      <div
        ...
        <WobbleCard
          containerClassName="col-span-1 lg:col-span-3 bg-orange-500 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
