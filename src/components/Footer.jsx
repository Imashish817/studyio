    ...
    <footer class="w-full">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="py-14 grid grid-cols-12 gap-x-5 gap-y-8">
                <div class="col-span-full xl:col-span-3 relative bg-gradient-to-tr from-orange-300 to-white rounded-2xl gap-12 p-6 xl:w-72 h-96 flex flex-col justify-center items-center">
                    
                    <a href="https://pagedone.io/" class="flex justify-center lg:justify-start">
                       <img src={logo}/>
                    </a>
                    <p class="text-center text-gray-600">Trusted in more than 100 countries & 5 million customers.
                ...
                <div class="block text-center xl:text-left xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3 xl:pl-5">
                    ...
                    <ul class="text-gray-900 transition-all duration-500 grid gap-6">
                        <li>support@study.io</li>
                        <li>+91 781 426 1211</li>
